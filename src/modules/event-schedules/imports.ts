...
/* Replace tips
    ...
    3- Replace event-schedules (Module) with the name of your module (e.g. users, event_schedules, etc.)
...
// export { EventSchedule as Entity } from 'src/database/events/event_schedules.entity';
