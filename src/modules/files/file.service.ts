...
import { FileUploadOptions } from './decorators/file-upload.decorator';
...
export class FileService {
	 ...
	 */
	async uploadFile(file: Express.Multer.File, fileOptions: FileUploadOptions = {}): Promise<FileResponseDto> {
		try {
			const { isPublic = false, prefix = '' } = fileOptions;
